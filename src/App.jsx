...
function App() {
  ...
  const profilePicture = './images/mikaela.jpg'
  const moreInfo = {
    age: '23 years old',
  ...
  const profilePicture2 = './images/truphena.jpg'
  const moreInfo2 = {
    age: '21 years old',
  ...
  const profilePicture3 = './images/gatere.jpg'
  const moreInfo3 = {
    age: '22 years old',
  ...
  const profilePicture4 = './images/harun.jpg'
  const moreInfo4 = {
    age: '30 years old',
